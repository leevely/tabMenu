...
function TabMenu(options) {  //TabMenu라는 클래스임
   // options = {selector: ".tab1"}
    this.init(options);     // this는 TabMenu를 의미!
    this.initEvent();
}
